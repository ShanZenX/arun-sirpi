...
const FloatingIcon = () => {
  return (
    <div className="fixed right-5 bottom-5 flex flex-col gap-3">
      <a href="tel:+918667003923" target="_blank" rel="noopener noreferrer" title="Call us">
      ...
      <a href="https://wa.me/8667003923" target="_blank" rel="noopener noreferrer" title="WhatsApp us">
